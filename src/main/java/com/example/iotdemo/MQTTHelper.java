...
public class MQTTHelper {
    ...
    public final String[] arrayTopics = {"DungTran18/feeds/cambien1", "DungTran18/feeds/cambien2"};

    final String clientId = "12345678";
    final String username = "DungTran18";
    final String password = "aio_NUna79eGvND50t3uls3sC6nCr8Jo";
